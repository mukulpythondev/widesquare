...
const PropertyListings = () => {
  ...
  const parseAmenities = (amenities) => {
    ...
    if (Array.isArray(amenities)) {
      if (amenities.every(a => typeof a === "string")) return amenities;
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="px-4 py-2 rounded-lg bg-gray-200 text-gray-700 hover:bg-blue-600 hover:text-white font-medium transition"
            >
              Property Requests
            </Link>
            <Link
              to="/admin/assign-property"
              className="px-4 py-2 rounded-lg bg-gray-200 text-gray-700 hover:bg-blue-600 hover:text-white font-medium transition"
            >
              Assign Property
            </Link>
                ...
                <div className="p-6">
                  ...
                  <div className="border-t pt-4 mt-4">
                    ...
                    <div className="flex items-center gap-2 text-gray-700 text-sm">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M16 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0ZM12 14c-4.418 0-8 1.79-8 4v2h16v-2c0-2.21-3.582-4-8-4Z"></path></svg>
                      {property.seller?.name || "Unknown"} <span className="font-bold">({property.seller?.role || "Unknown"})</span> ({property.seller?.email || "N/A"})
                    </div>
                  </div>
                </div>
              </motion.div>
