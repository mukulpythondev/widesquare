...
const StructuredData = ({ type, data }) => {
  ...
  const currentUrl = `https://Widesquare.vercel.app${location.pathname}`;
  ...
  const schemas = {
    website: {
      ...
      '@type': 'WebSite',
      name: 'Widesquare',
      url: 'https://Widesquare.vercel.app',
      potentialAction: {
        '@type': 'SearchAction',
    ...
    organization: {
      ...
      name: 'Widesquare',
      url: 'https://Widesquare.vercel.app',
      logo: 'https://Widesquare.vercel.app/logo.png',
      sameAs: [
    ...
    aiHub: {
      ...
      url: 'https://Widesquare.vercel.app/ai-property-hub',
      offers: {
        '@type': 'Offer',
        price: '0',
        priceCurrency: 'INR',
